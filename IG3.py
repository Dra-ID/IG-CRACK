...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r🚬 {P}[{b}{loop}{P}/{u}{len(id)}{P}]—{P}[{H}{cp}{P}]—{P}[{k}{ok}{x}]—[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
	ua = random.choice(['Mozilla/5.0 (Linux; Android 9; Redmi 6 Prime Build/OPM6.170103.030.K1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3655.145 Mobile Safari/537.36 EdgA/550.0.2922','Mozilla/5.0 (Linux; Android 6.0.1; Redmi 4 Prime Build/OPM6.154616.030.K1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3755.136 Mobile Safari/537.36 EdgA/560.0.2371','Mozilla/5.0 (Linux; Android 11; CPH2269) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 6.0; Nexus 5 BuildMRA58N) AppleWebKit/537.36 (KHTML, likeGecko) Chrome/90.0.4430.85 Mobile Safari537.36 EdgA/90.0.818.46','WhatsApp/2.17.38 Mozilla/5.0 (Linux; U; Android 6.1; en-us; DV Build/Donut) AppleWebKit/537.36 (KHTML, like Gecko) Safari/537.36','[Mozilla/5.0 (Linux; Android 8.0.0; XLC50L) AppleWebKit/537.36 (KHTML, like Gecko)Chrome/35.0.3896.9957 Mobile Safari/537.36[FBAN/EMA;FBLC/en_GB;FBAV/35.0.3896.9957;]','Dalvik/1.6.0 (Linux; U; Android 4.0.4; T970 Build/IMM76D)100.48.122; Profile/MIDP-2.1 Configuration/','Dalvik/1.6.0 (Linux; U; Android 4.2.2; A850 Build/JDQ39) Configuration/CLDC-1.1; Opera Mini/att/4.2.','Dalvik/1.4.0 (Linux; U; Android 2.3.6; GT-S5300 Build/GINGERBREAD)/CLDC-1.1; Opera Mini/att/4.2.','Dalvik/1.4.0 (Linux; U; Android 2.3.6; HUAWEI Y210-0100 Build/HuaweiY210-0100)','Dalvik/1.4.0 (Linux; U; Android 2.3.6; GT-S5300 Build/GINGERBREAD)','[Dalvik/2.1.0 (Linux; U; Android 9; SM-A805F Build/PPR1.180610.011)]','Mozilla/5.0 (iPad; CPU OS 10_3_3 like Mac OS X) AppleWebKit/603.3.8 (KHTML, like Gecko) Mobile/14G60]','Mozilla/5.0 (iPhone; CPU iPhone OS 13_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/79.0.3945.73 Mobile/15E148 Safari/604','Dalvik/2.1.0 (Linux; U; Android 10; moto g(7) power Build/QCOS30.85-18-8)','Dalvik/2.1.0 (Linux; U; Android 10; SM-G975U Build/QP1A.190711.020)','Dalvik/2.1.0 (Linux; U; Android 12; moto g stylus 5G Build/S2RES32.29-16-1-11)','Dalvik/2.1.0 (Linux; U; Android 12; V30 Build/SP1A.210812.016)'])
...
def crackfree(idf,pwv):
	global loop,ok,cp
	sys.stdout.write(f"\r \033[97mcrack {H}{url}{N} {loop}/{len(ID2)} OK:{len(OK)} CP:{len(CP)}  "),
	sys.stdout.flush()
	ua = random.choice(['Davik/2.1.0 (Linux; U; Android {android_version}; {model_device} Build/{build_device}) [FBAN/MessengerLite;FBAV/{versi_chrome};FBPN/com.facebook.mlite;FBLC/{language};FBBV/{versi_app};FBCR/{simcard};FBMF/{merk_device};FBBD/{brand_device};FBDV/{model_device};FBSV/{android_version};FBCA/{cpu_device};FBDM/','Dalvik/1.6.0 (Linux; U; Android 4.0.4; T970 Build/IMM76D)100.48.122; Profile/MIDP-2.1 Configuration/','Dalvik/1.6.0 (Linux; U; Android 4.2.2; A850 Build/JDQ39) Configuration/CLDC-1.1; Opera Mini/att/4.2.','Dalvik/1.4.0 (Linux; U; Android 2.3.6; GT-S5300 Build/GINGERBREAD)/CLDC-1.1; Opera Mini/att/4.2.','Dalvik/1.4.0 (Linux; U; Android 2.3.6; HUAWEI Y210-0100 Build/HuaweiY210-0100)','Dalvik/1.6.0 (Linux; U; Android 4.1.2; ST26i Build/11.2.A.0.31)AWEIY511-U30)','[Dalvik/2.1.0 (Linux; U; Android 9; SM-A805F Build/PPR1.180610.011)]','Mozilla/5.0 (iPhone; CPU iPhone OS 13_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/79.0.3945.73 Mobile/15E148 Safari/604','Dalvik/2.1.0 (Android 9; L-03K Build/PKQ1.190522.001) [FBAN/MessengerLite;FBAV/141.0.0.2.117;FBPN/com.facebook.mlite;FBLC/en_US;FBBV/293513921;FBCR/Airtel;FBMF/Facebook;Facebook/lge;FBDV/L-03K;FBSV/9;FBCA'])
